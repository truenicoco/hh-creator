# This is stolen from https://github.com/pokerregion/poker/blob/master/poker/_common.py
# We used to rely on the lib that provided this but it is not maintained anymore.
# Thank you kissgyorgy for your work on that!
